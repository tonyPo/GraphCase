...
class InputLayerConstructor:
    ...
    def get_input_layer(self, node_ids, hub, feat=None, weight=None):
        ...
        next_in_feat, next_in_weight = self.get_next_hub(node_ids, hub, 'in', feat, weight)
        next_out_feat, next_out_weight = self.get_next_hub(node_ids, hub, 'out', feat, weight)
    ...
    def get_next_hub(self, node_ids, hub, direction, feat, weight):
        """
